...
urlpatterns = [
    ...
    path('api/social-login-callback/', views.social_login_callback, name='api_social_login_callback'),
    path('api/social-login-success/', views.social_login_success, name='social_login_success'),
